...
class Student:
    ...
    def add_student(self, name, age, grade):
        try:
            if not isinstance(name, str) or not isinstance(age, int) or not isinstance(grade, str):
                raise ValueError("Invalid input types. Name should be a string, age should be an integer, and grade should be a string.\n")
            if age < 0:
    ...
    def save_to_file(self, filename="C:\\Users\\QQ\\Desktop\\projct1\\IEEE-First-Project\\pythonProject\\student_db.csv"):
        try:
...
def main():
    ...
    # student_db.add_student("mohamed", 20, "A")
    ...
    student_db.add_student("Ali", 21, "B")
    student_db.add_student("bassant", 22, "C")
    student_db.view_students()
    ...
    # student_db.update_student("Alice", age=22, grade="A+")
    ...
    # print(student_db.load_from_file())
